      ...
      elseif areas.mouseInDiscard(mouseX, mouseY) then
        ...
        events.push({
          fn = function()
            ...
            self.laser.hidden = false
            self.laser.origin.x = lensX
            self.laser.origin.y = lensY
            self.laser.target.x = card.current.x
            self.laser.target.y = card.current.y
        ...
        events.push({
          fn = function()
            ...
            self.laser.origin.x = 0
            self.laser.origin.y = 0
            self.laser.target.x = 0
            self.laser.target.y = 0
            card:startDissolve()
            Token.new_fling(
              card.current.x,
              card.current.y,
