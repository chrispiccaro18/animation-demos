...
-- so each deck can throw a differently-themed escalation pattern
-- (core/escalation.lua's Escalation.pickSequence(deckId, ...)). Each deck's
-- sub-table carries its own `default`/level entries and its own
-- `maxPerTurn` cap list.
--
...
return {
  ...
  -- Placeholder: verbatim copy of "original"'s escalation config. Retune
  -- later around the Negative deck's progressNegative/threatNegative/flip
  -- theme.
  negative = {
    default = { mode = "random" },
    [1] = { mode = "predetermined", order = { "threatNegative" } },
    [2] = { mode = "predetermined", order = { "threat", "threat", "progressNegative" } },
    [3] = { mode = "predetermined", order = { "threat", "threat", "progressNegative" } },
    [4] = { mode = "predetermined", order = { "threat", "threat", "progressNegative", "drawToDtor" } },
    [5] = { mode = "predetermined", order = { "threat", "threat", "progressNegative", "drawToDtor" } },
